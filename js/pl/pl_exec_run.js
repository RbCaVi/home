...
initialize = () => fetch('pl_exec_run.wasm').then(response => WebAssembly.instantiateStreaming(response, {
  'env': {
...
let promiseInitialized = initialize();
